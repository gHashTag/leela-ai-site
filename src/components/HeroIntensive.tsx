...
interface HeroIntensiveProps {
  ...
  description: string;
  imageCaption: string;
  bonusLabelTitle: string;
  bonusLabelDescription: string;
}
            ...
            <div className="p-4 sm:col-span-4">
              <div className="mb-2 flex items-center gap-2 font-semibold text-violet-600">
                ...
                <div className="flex flex-col">
                  <span>{bonusLabelTitle}</span>
                  <span>{bonusLabelDescription}</span>
                </div>
              </div>
              <blockquote className="mt-2 border-l-4 border-gray-300 pl-4 italic text-gray-800">
                <em>
                  Играй и учись, развиваясь - Лила ведет тебя к истине познания
                  себя
                </em>
              </blockquote>
            </div>
